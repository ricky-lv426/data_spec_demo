...
- [data/measurements.csv](data/measurements.csv) — repeated measures per patient with clinical measurements.
 - [data/derived_patient_status.csv](data/derived_patient_status.csv) — one row per patient with computed BMI, weight category, blood pressure category, and assumed heights (derived output).
...
- [Processing workflow](processing_workflow.html) — describes the steps and script used to produce the derived dataset.
...
### Data dictionary: [data/derived_patient_status.csv](data/derived_patient_status.csv)
...
- [derived_patient_status.csv](data/derived_patient_status.csv)
